...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.logo','data' => ['class' => 'w-auto h-16 mx-auto text-indigo-600']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\E-Fire-test-Finn-1\resources\views/welcome.blade.php ENDPATH**/ ?>